...
class OpenAICompatibleAgenticProvider(OpenAICompatibleHeadersMixin, BaseLLMProvider):  # type: ignore[misc]  # providers.* re-exports are untyped (Any base); mixin is real at runtime
        ...
        for turn in range(self._max_turns):
            ...
            if tool_calls:
                ...
                for tc in tool_calls:
                    ...
                    tool_call_id = (
                        tc.get("id") or f"call_{turn}_{len(normalized_calls)}"
                    )
