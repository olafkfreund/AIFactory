...
Stored in .aifactory/github/pr/ and .aifactory/github/issues/
...
class PRReviewResult:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save review result to .aifactory/github/pr/ with file locking."""
...
class TriageResult:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save triage result to .aifactory/github/issues/ with file locking."""
...
class AutoFixState:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save auto-fix state to .aifactory/github/issues/ with file locking."""
        issues_dir = github_dir / "issues"
        issues_dir.mkdir(parents=True, exist_ok=True)
