...
def test_enabled_for_coder_when_flag_and_graph_present(tmp_path, monkeypatch):
...
def test_off_when_graph_missing(tmp_path, monkeypatch):
    monkeypatch.setenv("AIFACTORY_GRAPHIFY_ENABLED", "true")
