...
DENY_COMMANDS: frozenset[str] = frozenset(
    {
        ...
        "chown", "chgrp", "passwd", "useradd", "usermod", "visudo",
        "iptables", "nft", "ufw",
    }
)
...
PLAN_GRANTABLE_COMMANDS: frozenset[str] = frozenset(
    {
        # Python
        "uv", "uvx", "poetry", "pdm", "pipenv", "pip", "pip3",
        "pytest", "py.test", "tox", "nox", "coverage",
        "ruff", "mypy", "pyright", "black", "isort", "flake8", "pylint", "bandit",
        # JS/TS
        "npm", "npx", "pnpm", "yarn", "bun", "node", "deno",
        "jest", "vitest", "mocha", "eslint", "prettier", "tsc",
        "playwright", "cypress",
        # Rust
        "cargo", "rustc", "gofmt",
        # Go
