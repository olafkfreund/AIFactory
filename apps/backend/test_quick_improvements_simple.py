...
"""
        ...
        # Create sample implementation_plan.json
        plan = {
        ...
        (temp_dir / "implementation_plan.json").write_text(json.dumps(plan, indent=2))

        print(f"\n✓ Sample spec created in: {temp_dir.name}")
        print("  Files: spec.md, implementation_plan.json")
