"""GC regression for the background-task anchor (#1484).
...
from server.background import pending_count, spawn

# Explicit rather than relying on the collector's asyncio mode: ci.yml runs this
# directory with `-o asyncio_mode=auto`, but a plain `pytest <this file>` from
# the repo root finds no config file and defaults to strict.
