    ...
    try:
        ...
        if endpoint:
            try:
                ...
                # Factory#608: the probe gets its OWN exporter, with a short
                # deadline. See _PROBE_TIMEOUT_SECONDS — the exporter that does
                # the real work keeps the full budget, because it retries in the
                # background where nobody is waiting.
                _verify_export_auth(
