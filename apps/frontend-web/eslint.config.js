// ESLint 9 flat config for the AIFactory web frontend (#647).
//
...
// standards aim for, mirroring CFactory#112.
//
...
//
// TODO(#647): ratchet the warn-listed rules below back up to "error" as the
...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      // #651 boundary discipline: ban `as unknown as` double-casts; parse at the
      ...
      "no-restricted-syntax": [
        "warn",
        {
          ...
          message:
            "Avoid `as unknown as` double-casts; validate/parse at the boundary (Zod) instead (#651).",
        },
      ],

      // --- Deferred to "warn" for the legacy tree (TODO #647: → "error") ------
      ...
      // deferring them keeps the gate green while #651 (Zod boundaries) lands.
      ...
      // --- Legacy-prevalent rules deferred to "warn" (TODO #647: → "error") ---
