...
export function initializePRReviewListeners(): void {
  ...
  window.API.github.onPRReviewProgress(
  ...
  window.API.github.onPRReviewComplete(
  ...
  window.API.github.onPRReviewError(
...
export function startPRReview(projectId: string, prNumber: number): void {
  ...
  window.API.github.runPRReview(projectId, prNumber);
}
...
export function startFollowupReview(projectId: string, prNumber: number): void {
  ...
  window.API.github.runFollowupReview(projectId, prNumber);
}
