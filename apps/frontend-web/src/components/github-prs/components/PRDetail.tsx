...
import type { NewCommitsCheck, PRLogs as PRLogsType } from '../../../shared/types/github-api';
...
interface PRDetailProps {
  ...
  onApprovePR: (body: string) => Promise<boolean>;
...
export function PRDetail({
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const approvalMessage = `## ✅ AI Factory PR Review - APPROVED\n\n${reviewResult.summary}\n\n---\n*This approval was generated by AI Factory.*`;
      await onApprovePR(approvalMessage);
    } finally {
      setIsPosting(false);
    }
  };
  ...
  const handleAutoApprove = async () => {
    ...
    try {
      ...
      const approvalMessage = `## AI Factory Review - APPROVED & MERGED
...
*This automated review found no blocking issues. The PR has been approved and merged.*
