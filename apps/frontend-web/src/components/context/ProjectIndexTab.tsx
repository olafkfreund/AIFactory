      ...
      <div className="p-6 space-y-6">
        ...
        {projectIndex && (
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  {projectIndex.services && Object.keys(projectIndex.services).length > 0 && (
                    <Badge variant="secondary">
                ...
                {projectIndex.languages && Object.keys(projectIndex.languages).length > 0 && (
            ...
            {/* Infrastructure */}
            {projectIndex.infrastructure && Object.keys(projectIndex.infrastructure).length > 0 && (
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">
                  Infrastructure
                </h3>
            ...
            {/* Conventions */}
            {projectIndex.conventions && Object.keys(projectIndex.conventions).length > 0 && (
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">
                  Conventions
                </h3>
