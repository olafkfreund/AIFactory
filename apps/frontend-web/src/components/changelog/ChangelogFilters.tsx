            ...
            <CardContent className="space-y-4">
              {isLoadingGitData ? (
                <div className="flex flex-col items-center justify-center py-6 text-muted-foreground">
                  ...
                  <span className="text-xs">Loading branches and tags...</span>
                </div>
              ) : (
              <>
              {/* History Type */}
                  ...
                  {tags.length === 0 ? (
                    <div className="flex items-start gap-2 p-3 rounded-md bg-muted/50 text-muted-foreground">
                      ...
                      <div className="text-xs">
                        <p className="font-medium">No git tags found</p>
                        <p className="mt-1">Create a tag first with:</p>
                        <code className="block mt-1 text-[10px] bg-background px-1.5 py-0.5 rounded">
                          git tag v1.0.0
                        </code>
                      </div>
                    </div>
                ...
                <div className="space-y-2">
                  {tags.length === 0 ? (
                    <div className="flex items-start gap-2 p-3 rounded-md bg-muted/50 text-muted-foreground">
                      ...
                      <div className="text-xs">
                        <p className="font-medium">No git tags found</p>
                        <p className="mt-1">Create a version tag first:</p>
                        <code className="block mt-1 text-[10px] bg-background px-1.5 py-0.5 rounded">
                          git tag v1.0.0
                        </code>
                        <p className="mt-2">Or use "Recent Commits" mode instead.</p>
                      </div>
                    </div>
                  ) : (
                    <>
