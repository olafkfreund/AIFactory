...
// Build (AIFactory) is the current active entry; the others link out with their
// per-service accent dot. Hosts are build-time overridable via VITE_*_URL,
// defaulting to the live portals. First step of the unified shell across the
// family (mirrors the CFactory cockpit switcher).
...
const PORTALS: { key: string; label: string; dot: string; url: string; current: boolean }[] = [
  ...
  { key: 'build', label: 'Build', dot: '#fabd2f', url: '', current: true },
