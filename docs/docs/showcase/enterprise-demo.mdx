...
While the agents are running, here's what the AIFactory portal shows: the Kanban board with three in-progress tasks, the Live Agent Console streaming each agent's output, and the final GitHub PRs view with three new pull requests ready for review.

<video controls width="100%" src="/AIFactory/recordings/enterprise-demo-browser.mp4" />
