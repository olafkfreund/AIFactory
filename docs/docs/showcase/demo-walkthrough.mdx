...
The script closes any leftover issues on `dataseeek/aifactory-demo` and seeds three fresh ones.

> _Screenshot: `screenshots/11-github-issues-sync.png` — Phase D will capture this against the running portal._
...
> _Screenshot: `screenshots/01-welcome.png`_
...
> _Screenshot: `screenshots/03-kanban.png`_
...
> _Screenshot: `screenshots/06-task-detail-plan.png`_
...
> _Screenshot: `screenshots/09-live-agent-console.png`_
...
> _Screenshot: `screenshots/08-task-detail-files.png` (showing the final diff)_
