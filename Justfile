# AIFactory canonical commands.  Run `just --list` for the full menu.
#
# Categories:
#   - setup:  install / configure
#   - dev:    run locally
#   - docs:   the Docusaurus site at https://dataseeek.github.io/AIFactory/
...
# Start the FastAPI web-server (port 3101)
backend:
