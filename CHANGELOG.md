...
- Live Console now also streams the **spec-creation / planning phase**, not just the build phase — the rmux passive-session hook was added to `start_spec_creation` so the whole agent run is visible in the console from the start.
