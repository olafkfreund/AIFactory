...
class TestSessionState:
    ...
    def test_defaults(self, tmp_path) -> None:
        s = SessionState(
            spec_id="001",
            session_name="aifactory-task-001",
...
class TestCreateForTask:
    ...
    async def test_records_session_in_registry(
        ...
        assert state.session_name == "aifactory-task-001"
